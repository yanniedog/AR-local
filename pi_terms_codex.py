...
def prompt(job: dict) -> str:
    return (
        ...
        'When reviewed_structure is present, use only its exact clause locators '
        '(start, end, page and section); retain required table headers, units and '
        'footnote associations. Never replace reviewed locators with mechanical '
        'boundaries. For unstructured input only, source_spans supplies deterministic '
        'start/end offsets and the original text '
