(function () {
    ...
    var BRAND_MAP = {
        ...
        'anz plus': { short: 'ANZ+', icon: '/assets/banks/anz.png', aliases: [] },
        ...
        'boq specialist': { short: 'BOQS', icon: '/assets/banks/bank-of-queensland.png', aliases: [] },
        ...
        'unloan': { short: 'Unloan', icon: '/assets/banks/commonwealth-bank-of-australia.png', aliases: [] },
        ...
        'banksa': { short: 'BSA', icon: '/assets/banks/st-george-bank.png', aliases: ['bank sa'] },
