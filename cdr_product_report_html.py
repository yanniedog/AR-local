...
input,select,button{font:inherit;color:inherit;background:#202c3e;border:1px solid #526078;border-radius:6px;padding:8px}
input{flex:1;min-width:230px}a{color:#89cafa}table{border-collapse:collapse;width:100%;font-size:14px}
...
<div class="controls"><input id="search" aria-label="Search bank, product or fine print" placeholder="Search bank, product or fine print"><select id="bank" aria-label="Bank"><option value="">All banks</option></select><select id="section" aria-label="Product family"><option value="">All product families</option><option>Mortgage</option><option>Savings</option><option>TD</option></select></div>
