...
def run_once(args: argparse.Namespace) -> int:
    ...
    terms_raw_root: Optional[Path] = None
    if use_ram_stage:
    ...
    if terms_capture is not None:
        finalized = {**finalized, "terms_evidence": terms_capture}
