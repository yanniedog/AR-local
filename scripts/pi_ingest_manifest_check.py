...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--alert", action="store_true", help="Send email when stale.")
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    stale = run_date < expected and now_utc >= ready_at
    payload = {
    ...
    if stale and args.alert:
        ...
        details = (
            f"GitHub manifest run_date={run_date} is older than expected {expected}.\n"
            f"generated_at={generated_at}\n"
