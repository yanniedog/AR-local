...
| **Stable recovery policy** | `RuntimeWatchdogSec=off`, `RebootWatchdogSec=off` | Avoids reboot loops during normal boot or ingest recovery; bounded network and service timers perform self-healing instead. |
