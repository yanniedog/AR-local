...
The generator above is exactly 45774 UTF-8/LF bytes, 304 lines, SHA-256
`241fab19f9e0d3994302372ac884f853fb1d4f69ec5cdadf9d40de35e7cf5701`.
...
if($scriptBytes.Length-ne45774-or$script.Split([char]10).Count-ne304-or$scriptSha-cne'241fab19f9e0d3994302372ac884f853fb1d4f69ec5cdadf9d40de35e7cf5701'){throw 'sequence-7 generator binding mismatch'}
$tokens=$null;$parseErrors=$null;[Management.Automation.Language.Parser]::ParseInput($script,[ref]$tokens,[ref]$parseErrors)|Out-Null
...
`99a500463ba80b6ab19a910697b483f1ab0a13b249221a88102eff5a7d050903`.
