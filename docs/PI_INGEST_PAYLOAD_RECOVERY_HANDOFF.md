...
if($scriptBytes.Length-ne71260-or$script.Split([char]10).Count-ne464-or$scriptSha-cne'be2bf7562f4b1f79f1a5ae3d17388791817a391e4d0b595878ab97c2231f7107'){throw 'sequence-7 generator binding mismatch'}
$tokens=$null;$parseErrors=$null;[Management.Automation.Language.Parser]::ParseInput($script,[ref]$tokens,[ref]$parseErrors)|Out-Null
