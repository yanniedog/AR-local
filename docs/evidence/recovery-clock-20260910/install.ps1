# D-026 exact ordinary-user action transition. Does not start a backup.
$ErrorActionPreference='Stop'
$root='C:\code\backups\AR-local-user-session\recovery-clock-20260910-v7'
$deploymentPath=Join-Path $root 'private-tools-deployment.json'
$deploymentSha='8ea5b37d14f5e8c35e690bfadae0dc2f7823703fceb1fde33477460856051330'
$intent=Join-Path $root 'D-026-activation-intent.json'
if((Get-FileHash -LiteralPath $intent).Hash.ToLowerInvariant() -cne '7610ca222a8fb55a456470f7ed1ea362bdf809ea183f710aaaf57aea0b5cc461'){throw 'Activation intent changed.'}
