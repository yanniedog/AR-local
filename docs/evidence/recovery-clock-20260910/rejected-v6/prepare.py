...
ROOT = Path(r'C:\code\backups\AR-local-user-session\recovery-clock-20260910-v6')
SOURCE = ROOT / 'source'
...
assert pointer['result'] == 'FAIL'
assert pointer['record_sha256'] == '90122d6fe16189b2dea9d31041cb87b39e6d0e7ab94ac03e5ea2d06923aa149d'
...
deployment = dict(contract, schema='ARL-PRIVATE-GIT-V1', operator_sid=config['operator_sid'],
    decision_id='D-024-RECOVERY-CLOCK-20260910', candidate_sha=COMMIT,
...
decision = dict(id=deployment['decision_id'], result='NOT_STARTED',
    ...
    acceptance=['Exact merged PR669 Linux/Windows CI and substantive feedback disposition',
...
decision_sha = create(ROOT / 'D-024-activation-intent.json', decision)
for file in (config_path, contract_path, deployment_path, ROOT / 'D-024-activation-intent.json'):
