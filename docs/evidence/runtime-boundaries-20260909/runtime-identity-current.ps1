...
$baseline='C:\code\backups\AR-local-user-session\source-auth-publication-20260908-v4\task-after.xml'
if((Get-FileHash -LiteralPath $baseline).Hash.ToLowerInvariant() -cne '899762f09d2c9db6ccc25718abbd4f8cd85a6340fd236fcf4845a3b7fd6d7ed0'){throw 'Task baseline changed.'}
...
$source='C:\code\backups\AR-local-user-session\source-auth-publication-20260908-v4\source'
...
$raw=& $python -I -S -B $runtimeSource --config (Join-Path (Split-Path $source) 'user-session-backup.json') --config-sha256 '5bdb944363ec5276ea8662f99ba4d37e3852f2049bb8fd590a8cc2f664b798ca' --receiver-sha 'cbf920eceedcfd5cc19bd75d86351ddbc7b39e2e' --production-sha '3de4d35d1f3af8b647477bfeb327c9466f5c49f6'
...
[ordered]@{runtime_binding='PASS';checked_at_hobart=(Get-Date -Format o);
  ...
  config_sha256='5bdb944363ec5276ea8662f99ba4d37e3852f2049bb8fd590a8cc2f664b798ca';
